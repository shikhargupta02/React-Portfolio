    ...
    <div name="home" className="w-full min-h-screen bg-[#0a192f]">
      ...
      <div className="pt-56 pb-24 max-w-[1000px] mx-auto px-4 flex flex-col justify-center h-full text-[#54dde4]">
        ...
        <p className="px-5 text-[#d1dcff] text-2xl">
          ...
          <span className="text-[#54dde4]"> C++, Javascript, Python.</span>
          <br />
          <br />
          My field of interest's are building new
          <span className="text-[#54dde4]"> Web Technologies and Products</span>
          and also in areas related to
          <span className="text-[#54dde4]"> Deep Learning</span> and
          <span className="text-[#54dde4]"> Natural Language Processing.</span>
          <br />
          <br />
          Whenever possible, I also apply my passion for developing products
          with <span className="text-[#54dde4]"> Node.js</span> and modern
